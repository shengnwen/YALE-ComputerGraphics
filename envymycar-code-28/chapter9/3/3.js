...
//NVMCClient.loadCarModel = function (gl, data){
...
//
//
//	this.carRender = new SglModelRenderer(gl);
//	this.carTechnique = new SglTechnique( gl,
...
//NVMCClient.drawCar = function (gl, framebuffer) {//line 142,
...
//	var bbt = this.sgl_car_model;
//	gl.depthMask(false);
//	gl.enable(gl.BLEND);
//	gl.blendFunc( gl.ONE,gl.ONE_MINUS_SRC_ALPHA);
//
//	this.carRender.begin();
//	if(framebuffer)
//		this.carRender.setFramebuffer(fb);
//	this.carRender.setTechnique(this.carTechnique);
//	this.carRender.setGlobals({
...
//		"TEXTURE": 1
//		//"LIGHTS_COLOR": [0.83,0.56,0.72]
//	});
//	if( !this.sgl_car_model.textureSgl)
//		this.sgl_car_model.textureSgl = new SglTexture2D(gl,this.sgl_car_model.texture);
//	this.carRender.setPrimitiveMode("FILL");
//	this.carRender.setModel(this.sgl_car_model);
//	this.carRender.setTexture(0,this.carRender.textureSgl);
//	this.carRender.setModel(this.sgl_car_model);
//	this.carRender.renderModel();
//	this.carRender.end();
//	gl.disable(gl.BLEND);
//	gl.depthMask(true);
//};
...
//
//	if( !this.sgl_car_model.textureSgl)
//		this.billboardCloudTree.textureSgl = new SglTexture2D(gl,this.sgl_car_model.texture );
//	gl.depthMask(false);
//	gl.enable(gl.BLEND);
//	gl.blendFunc( gl.ONE,gl.ONE_MINUS_SRC_ALPHA);
...
NVMCClient.onInitialize = function () {
	...
	this.createReflectionMap(gl);
 	this.loadCarModel(gl,NVMC.resource_path+"Clefairy/pippidoll.mtl");
