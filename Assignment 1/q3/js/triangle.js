...
function drawTriangle() {
    ...
    //myCanvas.style.border = "yellow 1px solid";
    ...
    var drawLine = function(px, py, qx, qy) {
        var startX = px * width;
        var startY = py * height;
        ...
        if (startX == endX && startY == endY) {
            document.getElementById("info").textContent += " Triangle Degeneration!";
